...
const dinners=[
    {name:"breakfast",imgs:[{imgSrc:a0,foodName:"上堡油条",foodDetail:"入粥口感滑溜",effect:"吃多长痘"},
        {imgSrc:b0,foodName:"上堡蒸饺",foodDetail:"萝卜丝馅，多油",effect:"无敌"},
        {imgSrc:c0,foodName:"上堡泡粉",foodDetail:"香菇，猪油，撒些葱",effect:"一碗一天状态好"}]},
    {name:"lunch",imgs:[{imgSrc:a1,foodName:"微辣莴笋",foodDetail:"切成丝，红辣椒小炒",effect:"解馋"},
        {imgSrc:b1,foodName:"黄焖鸡米饭",foodDetail:"香嫩滑溜的口感",effect:"老陈教我的菜"},
        {imgSrc:c1,foodName:"酸辣大白菜",foodDetail:"酸酸辣辣就是我",effect:"省钱"}]},
    {name:"teatime",imgs:[{imgSrc:a2,foodName:"桃源山茶",foodDetail:"微苦，带香",effect:"清热"},
        {imgSrc:b2,foodName:"上堡豆浆",foodDetail:"豆浆和麻子粿",effect:"解渴"},
        {imgSrc:c2,foodName:"麻子粿",foodDetail:"以前是5毛钱一份",effect:"解饿"}]},
    {name:"dinner",imgs:[{imgSrc:a3,foodName:"闷菊花菜",foodDetail:"麻麻做的菊花菜",effect:"好吃的很"},
        {imgSrc:b3,foodName:"爆炒小龙虾",foodDetail:"啤酒焖出红色龙虾",effect:"贵"},
        {imgSrc:c3,foodName:"芋头炆墨鱼",foodDetail:"山珍和海味，家宴一等",effect:"请客用"}]},
    {name:"supper",imgs:[{imgSrc:a4,foodName:"垃圾食品1号",foodDetail:"写程序，吃垃圾食品",effect:"不好"},
        {imgSrc:b4,foodName:"垃圾食品2号",foodDetail:"没女朋友，吃垃圾食品",effect:"增肥"},
        {imgSrc:c4,foodName:"垃圾食品3号",foodDetail:"没挣钱，吃垃圾食品",effect:"吃不得"}]},]
